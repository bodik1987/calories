  ...
  return (
    <Drawer.Root open={open} onClose={onClose}>
      <Drawer.Portal>
        ...
        <Drawer.Content className="!h-fit bg-panel dark:bg-dark-panel text-[#1B0C1B] dark:text-neutral-50 font-myFont flex flex-col justify-end rounded-t-[10px] mt-24 fixed z-40 bottom-0 left-0 right-0 outline-none overflow-hidden">
