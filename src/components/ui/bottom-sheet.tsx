...
export default function BottomSheet({
  ...
  return createPortal(
    <Drawer.Root open={open} onClose={onClose}>
      ...
      <Drawer.Content className="h-fit! container bg-panel text-[#1B0C1B] flex flex-col justify-end rounded-t-[18px] mt-24 fixed z-30 bottom-0 left-0 right-0 outline-none overflow-hidden">
        <Drawer.Title />
        <Drawer.Description />
