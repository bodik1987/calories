...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="sticky z-10 top-0 inset-x-0 bg-[#F3F4FA] backdrop-blur-md dark:bg-linear-to-b dark:from-dark-panel dark:to-dark-panel p-3 select-none shadow-lg">
